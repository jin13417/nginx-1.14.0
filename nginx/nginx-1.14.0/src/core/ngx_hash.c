   ...
   /* 获取对应的桶 */ 
	...
	/*1，如果key 的长度相等*/	
       ...
       /*2 key的内容也相等*/
        ...
        /*3  已找到节点，直接返回key对应的vlaue*/
        return elt->value;

    next:
        /*通过name的地址+ name的偏移量可以找到下一个数据的起始地址*/
